...
**必须阅读 `docs/design/DESIGN.md` 后再做任何UI/视觉决策。**

所有字体、颜色、间距、阴影、圆角、动效规范都定义在 `docs/design/DESIGN.md` 中。
不要偏离 `docs/design/DESIGN.md` 中定义的规范，除非有用户明确授权。
...
### Aesthetic Direction
- 延续当前已落地的工业功能主义白底工具风，遵循 `docs/design/DESIGN.md` 与当前基线样式 `static/design_variants/style2.css` 的方向。
...
5. 复用现有设计系统：优先遵守 `docs/design/DESIGN.md` 中已定义的颜色、间距、圆角、阴影、字体和动效规范，不另起一套视觉语言。
