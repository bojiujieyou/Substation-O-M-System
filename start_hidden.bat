...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
    "Start-Process -FilePath 'python' -ArgumentList 'app.py' -WorkingDirectory '%CD%' -WindowStyle Hidden -RedirectStandardOutput '%CD%\\flask.log' -RedirectStandardError '%CD%\\flask.err.log'"
